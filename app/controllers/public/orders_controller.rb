class Public::OrdersController < ApplicationController
  ...
  def order_params
    params.require(:order).permit(:customer_id,:address_id, :payment_method,
    :delivery_telephone_number, :delivery_method,
    :delivery_address, :delivery_code, :delivery_name, :delivery_name_kana,
    :cost_price,:amount_billed_or_claimed, :order_status,
    order_destination_attributes: [:id, :address, :postal_code, :name, :name_kana, :telephone_number])
  end
end
